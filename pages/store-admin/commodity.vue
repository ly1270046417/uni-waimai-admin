...
export default {
  ...
  data() {
    ...
    return {
      ...
      table1:{
        // 表格数据请求地址
        action:"admin/store-admin/commodity/sys/getList",
        // 表格字段显示规则
        columns: [
          { key:"name", title:"名称", type:"text", width:120 },
          { key:"goods_thumb", title:"菜品图片", type:"image", limit:9 , defaultValue:'' },
          { key:"category", title:"分类", type:"text", width:180,
          ...
          { key:"month_sell_count", title:"月销量", type:"number", width:120, defaultValue:"" },
          { key:"price", title:"价格", type:"number", width:120, defaultValue:"" },
          ...
          //   data:genderData
          // },
          { key:"add_date", title:"上架时间", type:"time", width:160, sortable:"custom" },
          { key:"last_modify_date", title:"最后修改时间", type:"time", width:160, sortable:"custom" },
      ...
      queryForm1:{
        ...
        columns:[
          ...
          { key:"goods_thumb", title:"图片地址", type:"text", width:180, mode:"%%" },
          { key:"category_id", title:"分类", type:"text", width:180, mode:"%%" },
          { key:"month_sell_count", title:"月销量", type:"number", width:120, mode:"=" },
          { key:"price", title:"价格", type:"number", width:120, mode:"=" },
          { key:"add_date", title:"上架时间", type:"time", width:160, mode:"%%" },
          { key:"last_modify_date", title:"最后修改时间", type:"time", width:160, mode:"%%" },
        ]
      },
      form1: {
        // 表单请求数据，此处可以设置默认值
        ...
        props: {
          ...
          // 表单字段显示规则
          columns:[
            { key:"name", title:"菜品名称", type:"text", show:["add"] },
            { key:"goods_thumb", title:"菜品图片", type:"image", limit:9 },
            { key:"category_id", title:"分类", type:"remote-select",placeholder:"请选择分类",
            ...
            { key:"month_sell_count", title:"月销量", type:"number" },
  ...
  methods: {
    ...
    init(options) {
      ...
      this.queryForm1.formData.user_id=userInfo.uid
    ...
    getCategoryList(){
      this.vk.callFunction({
        url: 'admin/store-admin/category/sys/getList',
        data:{},
        success: (data) => {
    ...
    addBtn(){
      ...
      that.form1.props.action = 'admin/store-admin/commodity/sys/add';
    ...
    // 显示修改页面
    updateBtn({ item }){
      that.form1.props.action = 'admin/store-admin/commodity/sys/update';
    ...
    deleteBtn({ item, deleteFn }){
      deleteFn({
        action:"admin/store-admin/commodity/sys/delete",
        data:{
          _id: item._id
        }
      });
